...
sys.stdout = Logger(strftime("Logfiles/Emeryville_Restaurant_Menus_%H_%M_%m_%d_%Y.txt"))
...
br.get('https://www.grubhub.com/search?orderMethod=pickup&locationMode=PICKUP&facetSet=umami&pageSize=20&latitude=37.83133316&longitude=-122.28525544&radius=1&countOmittingTimes#ghs-291950')
time.sleep(30)
