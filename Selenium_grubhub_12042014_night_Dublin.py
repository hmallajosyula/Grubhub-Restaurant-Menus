...
sys.stdout = Logger(strftime("Logfiles/Dublin_Restaurant_Menus_%H_%M_%m_%d_%Y.txt"))
...
br.get('https://www.grubhub.com/search?orderMethod=pickup&locationMode=PICKUP&facetSet=umami&pageSize=20&latitude=37.702152&longitude=-121.93579&radius=3&countOmittingTimes')
time.sleep(30)
