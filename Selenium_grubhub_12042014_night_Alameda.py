...
sys.stdout = Logger(strftime("Logfiles/Alameda_Restaurant_Menus_%H_%M_%m_%d_%Y.txt"))
...
br.get('https://www.grubhub.com/search?orderMethod=pickup&locationMode=PICKUP&facetSet=umami&pageSize=20&latitude=37.7652&longitude=-122.241646&radius=2&countOmittingTimes&pageNum=1')
time.sleep(30)
