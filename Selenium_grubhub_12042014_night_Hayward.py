...
sys.stdout = Logger(strftime("Logfiles/Hayward_Restaurant_Menus_%H_%M_%m_%d_%Y.txt"))
...
br.get('https://www.grubhub.com/search?orderMethod=pickup&locationMode=PICKUP&facetSet=umami&pageSize=20&latitude=37.66882&longitude=-122.080795&radius=4&countOmittingTimes')
time.sleep(30)
