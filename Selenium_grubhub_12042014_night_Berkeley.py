...
sys.stdout = Logger(strftime("Logfiles/Albany_Restaurant_Menus_%H_%M_%m_%d_%Y.txt"))
...
br.get('https://www.grubhub.com/search?orderMethod=pickup&locationMode=PICKUP&facetSet=umami&pageSize=20&latitude=37.87159347&longitude=-122.27274323&radius=3&countOmittingTimes')
time.sleep(30)
